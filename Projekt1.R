...
#ROZKŁAD LICZEBNOŚCI PROCENTOWY-OSZCZĘDNOŚCI
...
wykres_w=barplot((sort(table(Oszczednosci)/306*100)), main = "Oszczędności",
      xlab = "Procent budżetu przeznaczony na oszczędności", ylab = "Procent osób [%]", col = "#42a683",
...
rozklad_l_k <- data.frame(
  Oszczędności=c("Mniej niż 5 procent", "5-10 procent","10-20 procent", "Powyżej 20 procent"),
  Liczność=sort(as.numeric(table(kobiety$Oszczednosci)))
)
rozklad_l_k

#ROZKŁAD LICZEBNOŚCI PROCENTOWY _ KOBIETY
...
wykres_k=barplot(sort(table(kobiety$Oszczednosci)/306*100), main = "Oszczędności kobiet",
        xlab = "Procent budżetu przeznaczony na oszczędności", ylab = "Procent kobiet [%]", col = "pink",
        names.arg = c("Mniej niż 5 procent", "5-10 procent","10-20 procent", "Powyżej 20 procent"),
        ylim=c(0,30))
...
rozklad_l_m <- data.frame(
  Oszczędności=c("Mniej niż 5 procent", "5-10 procent","10-20 procent", "Powyżej 20 procent"),
  Liczność=sort(as.numeric(table(mezczyzni$Oszczednosci)))
)
rozklad_l_m

#ROZKŁAD LICZEBNOŚCI PROCENTOWY _ MEZCZYZNI
...
wykres_m=barplot(sort(table(mezczyzni$Oszczednosci)/306*100), main = "Oszczędności mężczyzn",
            xlab = "Procent budżetu przeznaczony na oszczędności", ylab = "Procent mężczyzn [%]", col = "lightblue",
            names.arg = c("Mniej niż 5 procent", "5-10 procent","10-20 procent", "Powyżej 20 procent"),
            ylim=c(0,30))
...
dystrybuanta=plot(ecdf(dyst_k$Wiek), main="Dystrybuanta kobiet",col="#CF8580")
